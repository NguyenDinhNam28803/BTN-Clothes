/*
  # Insert Men Products for BTN Clothes Store
  
  ## Purpose
  This script inserts men's products data
  
  ## Usage
  Run this script with: npx supabase db query -f insert_men_products.sql
*/

-- First ensure we delete any existing men's products to avoid conflicts
DELETE FROM product_variants WHERE product_id LIKE '750e8400-e29b-41d4-a716-44665544%';
DELETE FROM products WHERE id LIKE '750e8400-e29b-41d4-a716-44665544%';
